jQuery.fn.wowSlider = function (D) {
    ...
    function r(f) {
        ...
        if (N) {
            ...
            if (c) {
				...
				if(c.id=="a1"){N.setAttribute("onclick", "null");}else if(c.id=="a2"){N.setAttribute("onclick", "f2()");}else if(c.id=="a3"){N.setAttribute("onclick", "f1()");}
    ...
    function E(f) {
        ...
        c.stop(1, 1).stop(1, 1).fadeOut(D.captionDuration / 3, function () {
			...
			if (ak=="Angeles"){
				document.getElementById('TX').innerHTML=" Angeles has an open and very active accommodation, adventure and nightlife. Interspersed throughout are shopping malls, wellness centers, and fitness gyms to those seeking other forms of relaxation. Angeles hotels have elegant supper clubs, discos and intimate cocktail lounges. Entertainment runs the scale from International headliners through bands and floorshows to small musical combos, guitarists and go-go dancers.";
			}			
        })
    }
